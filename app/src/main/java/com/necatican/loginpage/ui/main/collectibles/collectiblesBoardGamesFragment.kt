...
class collectiblesBoardGamesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_collectibles_board_games, container, false)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            collectiblesBoardGamesFragment().apply {
