...
class moviesAutographsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_movies_autographs, container, false)
        ...
        view.movies_posters.setOnClickListener { Navigation.findNavController(view).navigate(R.id.navigateToMoviesPostersPage)}
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            moviesAutographsFragment().apply {
