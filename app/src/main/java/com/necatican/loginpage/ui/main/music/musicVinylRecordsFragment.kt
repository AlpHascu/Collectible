...
class musicVinylRecordsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_music_vinyl_records, container, false)

        view.music_albums.setOnClickListener { Navigation.findNavController(view).navigate(R.id.navigateToMusicAlbumPage)}
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            musicVinylRecordsFragment().apply {
