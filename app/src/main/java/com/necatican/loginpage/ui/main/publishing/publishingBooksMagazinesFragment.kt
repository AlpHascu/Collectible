...
class publishingBooksMagazinesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_publishing_books_magazines, container, false)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            publishingBooksMagazinesFragment().apply {
