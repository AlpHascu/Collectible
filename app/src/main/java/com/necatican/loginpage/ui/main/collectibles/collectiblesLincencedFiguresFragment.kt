...
class collectiblesLincencedFiguresFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_collectibles_lincenced_figures, container, false)
        ...
        view.collectibles_card_games.setOnClickListener { Navigation.findNavController(view).navigate(R.id.navigateToCollectiblesCardGamesPage)}
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            collectiblesLincencedFiguresFragment().apply {
